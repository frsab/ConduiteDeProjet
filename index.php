...
*/
			case 'insertSprint' 			 	 :$controller->$sprintController->insert($_POST); break;
			case 'updateSprint' 				 :$controller->$sprintController->update($_POST); break;
			case 'removeSprint' 				 :$controller->$sprintController->remove($_GET["IDUSERSTORY"], $_GET["IDPROJECT"], $_GET["IDUSER"]); 
			case 'newSprint' 					 :$controller->$sprintController->newUserStory();                         break;
			case 'updateViewSprint'	 		 :$controller->$sprintController->updateUserStory($_GET["IDUSERSTORY"],$_GET["IDUSER"]);   break;
			case 'showSprint'				 :$controller->$sprintController->showall($_GET["IDPROJECT"]);break; 

			default :   $controller>$projectController->showAll(); break;    
	}	
}
else {
	$controller->$sprintController->showall();break;
