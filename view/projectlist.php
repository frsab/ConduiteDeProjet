...
float: right;
font-size: 16px;"> Last access : 18 october 2015 &nbsp; <a href="/scrum/?p=logout" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
					...
					<!--
                     <li  >
                        <a  href="registration.php"><i class="fa fa-laptop fa-3x"></i> Registration </a>
                    </li>
				...
				-->
                     <li  >
                        <a  class="active-menu"  href="/scrum/?p=showProjects"><i class="fa fa-table fa-3x"></i> Project List</a>
                    </li>
