      ...
      <div id="page-inner">
        <div class="row">
          <div class="col-md-12">
            ...
            <a href="/ConduiteDeProjet/?p=showKanban&IDUSER=<?php echo $_GET["IDUSER"]; ?>&IDPROJECT=<?php echo $_GET["IDPROJECT"]; ?>&IDSPRINT=<?php echo $_GET["IDSPRINT"]; ?>" class="btn btn-success">Back</a>
