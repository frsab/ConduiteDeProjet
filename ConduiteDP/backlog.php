                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>test d'une us très longue pour voir comment s'adapte le tableau</td>
                                            <td>1</td>
                                            <td>2</td>
                                            <td>To Do</td>
                                            <td>
                                              <a href="updateus.php" class= "btn btn-default"><i class=" fa fa-refresh "></i> Update</a>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td><button class="btn btn-danger"><i class="fa fa-pencil"></i> Delete</button></td>                                        </tr>
                                        <tr>
                                            <td>3</td>
                                            <td>US 3</td>
                                            <td>3</td>
