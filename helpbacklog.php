      ...
      <div id="page-inner">
        <div class="row">
          <div class="col-md-12">
           ...
           <h6>
            The goal of a backlog is to list your project user stories.
            You have to search and find what your program must do.


          </h6>
          <a href="backlog.php" class="btn btn-success">Let's Go !</a>
        </div>
      </div>         
    </div>
    <!-- /. PAGE INNER  -->
